...
export function shippingQuoteRequestOwnerEmail({
  ...
  const addressText = shippingAddress
    ? `${shippingAddress.line1}${shippingAddress.line2 ? `, ${shippingAddress.line2}` : ""}, ${shippingAddress.postalCode} ${shippingAddress.city}`
    : "Non renseignée";
...
export function formationLowSeatsAnnouncementEmail({ customerName, formationTitle, sessionDate, seatsLeft }) {
