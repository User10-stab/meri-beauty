 ...
 *
 * Appointments are deliberately gated on PENDING/CONFIRMED only — never
...
export async function reconcileExceptionalReservationFullRefund(
  ...
  if (reservationKind === "appointment") {
    // No cancelledAt/cancelledByUserId on Appointment — unlike the other two
    // models, it never had those fields.
