...
Ce lien expire dans ${expiresInMinutes / 60} heures pour des raisons de sécurité.
  ...
  const html = htmlWrapper(
    ...
    <table cellpadding="0" cellspacing="0" style="width:100%;background:#f9f8f5;border-radius:8px;padding:4px 20px;margin-bottom:24px;">
      <tbody>
        ...
        ${infoRow("Expire dans", `${expiresInMinutes / 60} heures`)}
      </tbody>
    </table>
...
/**
 * @param {{ customerName: string, orderNumber: number, refundAmount: number, manualRefund?: boolean, creditNoteAttached?: boolean }} params
 */
