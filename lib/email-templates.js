...
L'équipe Meri Beauty
  ...
  const html = htmlWrapper(
    ...
    <div style="text-align:center;margin:0 0 24px;">
      <a href="${verificationUrl}" style="display:inline-block;background:#2F3A2E;color:#ffffff;font-size:15px;font-weight:700;text-decoration:none;padding:14px 32px;border-radius:999px;">Vérifier mon adresse email</a>
    </div>
