 ...
 * @param {{name?:string,logo?:string|null,phone?:string|null,address?:string|null}|null} [branding]
 */
function buildEmailShell(title, bodyHtml, unsubscribeUrl = null, branding = null) {
  const name = branding && branding.name ? branding.name : "Meri Beauty";
  const logoUrl = branding && branding.logo
    ...
    : null;
  const phone = branding ? branding.phone : null;
  const address = branding ? branding.address : null;
...
<body style="margin:0;padding:0;background:#f9f9f7;font-family:Arial,Helvetica,sans-serif;">
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#f9f9f7;padding:40px 0;">
    <tr>
      <td align="center">
        <table class="mb-container" width="560" cellpadding="0" cellspacing="0" style="width:560px;max-width:560px;background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,.08);">
          <tr>
            <td class="mb-header" style="background:${darkColor};padding:26px 40px 22px;text-align:center;">
              ${logoBlock}
              ${nameBlock}
              ${contactBlock}
            </td>
          ...
          <tr>
            <td class="mb-body" style="padding:36px 40px 28px;">
              ${bodyHtml}
            </td>
          </tr>
          <tr>
            <td class="mb-footer" style="background:#f4f4f0;padding:20px 40px;text-align:center;">
              <p style="margin:0;font-size:12px;color:#999;">
                © ${new Date().getFullYear()} ${escapeHtml(name)} · Tous droits réservés
              </p>
              ${unsubscribeUrl ? `
              <p style="margin:4px 0 0;font-size:11px;color:#aaa;">
                Si vous ne souhaitez plus recevoir nos communications, <a href="${escapeHtml(unsubscribeUrl)}" style="color:#aaa;text-decoration:underline;">cliquez ici pour vous désabonner</a>.
              </p>` : ""}
            </td>
          </tr>
        </table>
