...
/**
 * Records that the customer never attended. Deliberately touches no Payment
 * and calls no Stripe: a no-show is exactly the case where the deposit is
 * kept, so issuing a refund here would invert the policy. Mirrors
