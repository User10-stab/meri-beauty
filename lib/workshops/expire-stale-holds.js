  ...
  for (const reservation of stale) {
    ...
    sendEmail({
      ...
      text:
        ...
        `Votre réservation pour l'atelier "${reservation.session.workshop.title}" a expiré faute de paiement dans le délai prévu. ` +
      ...
      html:
        ...
        `<p>Votre réservation pour l'atelier "${reservation.session.workshop.title}" a expiré faute de paiement dans le délai prévu. ` +
