...
vi.mock("@/lib/prisma", () => ({ prisma: {
  ...
  // Resolved by getTillCashOperatorUserId() — getAdminOperations widens
  // ADMIN/OWNER's own actorIds with this account's id, if any exists.
...
beforeEach(() => {
  ...
  // No till-cash-operator account in this fixture — actorIds stays just the caller's own id.
