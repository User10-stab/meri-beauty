...
export async function openRefundOperation({
  ...
  return prisma.$transaction(async (tx) => {
    ...
    if (context.invoice) {
      ...
      // B2C: no invoice was ever issued, therefore no credit note or refund
      // receipt is created. Once all legs settle, an administrator may send
      // the customer a plain refund-confirmation e-mail from Operations.
    }
