 ...
 *
 * @param {{ contract: { id: string, fixedRent: any, startDate: Date, dueDate?: Date|string|null }, staff: { id: string, userId: string }, user: { fullName: string, email: string, vatNumber?: string|null, isCompany?: boolean, billingProfile?: any } }} params
