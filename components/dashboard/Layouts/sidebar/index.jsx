...
export function Sidebar({ userRole, dashboardPermissions = [], pickupsToVerifyCount = 0, unreadNotificationsCount = 0 }) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed max-w-[290px] overflow-hidden border-r border-gray-200 bg-white transition-width duration-200 ease-linear dark:border-gray-800 dark:bg-gray-dark",
          isMobile ? " bottom-0 top-0 z-50" : "sticky top-0 z-30 h-screen",
          isOpen ? "w-full" : "w-0",
        )}
