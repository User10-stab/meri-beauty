...
export const metadata = {
  title: "Activités & Animateurs — Dashboard",
  description: "Gérez vos workshops, événements et animateurs.",
};
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-bold text-dark dark:text-white">
            Activités (Workshops & Événements)
          </h1>
          <p className="mt-1 text-sm font-medium text-gray-500 dark:text-dark-6">
            Planifiez des ateliers et des événements spéciaux animés par des intervenants externes.
          </p>
        </div>
