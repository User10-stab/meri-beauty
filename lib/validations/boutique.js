...
export const variantSchema = z
  .object({
    ...
    // Optional — the client doesn't require it up front, but it's needed for
    // an accurate Belgian Poste shipping quote (see lib/shipping.js). Left
    // unset (0), a variant just falls back to the cheapest weight tier.
    weightGrams: wholeNumber("Le poids").optional().default(0),
