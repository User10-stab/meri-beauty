...
export default async function RentalRequestsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* ── Client shell ───────────────────────────────────────────────── */}
      <Suspense fallback={<RentalRequestTableSkeleton />}>
        <RentalRequestsPageClient initialData={rentalRequests} services={services} />
      </Suspense>
    </div>
  );
}
...
function RentalRequestTableSkeleton() {
  return (
