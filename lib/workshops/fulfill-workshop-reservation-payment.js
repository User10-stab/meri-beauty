...
import { resolvePayeeForWorkshopSession, payeePaymentData } from "@/lib/payments/resolve-payee";
  ...
  ({ invoice } = await prisma.$transaction(async (tx) => {
    ...
    const payment = await tx.payment.create({
      data: {
        ...
        ...payeePaymentData(await resolvePayeeForWorkshopSession(tx, { sessionId: reservation.sessionId })),
