...
L'équipe ${sellerName}
  ...
  const lineRows = lines
    .map((l) => `
      <tr>
        ...
        <td style="padding:11px 14px;font-size:14px;color:#777;text-align:right;border-bottom:1px solid #f0ede8;white-space:nowrap;">€${Number(l.unitPrice).toFixed(2)}</td>
        <td style="padding:11px 14px;font-size:14px;font-weight:600;color:#2F3A2E;text-align:right;border-bottom:1px solid #f0ede8;white-space:nowrap;">€${Number(l.lineTotal).toFixed(2)}</td>
      </tr>`)
    .join("");
  ...
  const html = htmlWrapper(
    ...
    <p style="margin:0 0 16px;font-size:15px;color:#555;line-height:1.7;">
      Une nouvelle facture a été émise par l'équipe <strong>${escapeHtml(sellerName)}</strong>.
    ...
    <!-- ── Invoice summary card (screenshot style: beige bg + gold border + bold label:value) ── -->
      ...
      <tr>
        <td style="padding:16px 20px;line-height:2;">
          <p style="margin:0;font-size:14px;color:#2F3A2E;">
            <strong>Numéro de facture :</strong>&nbsp;${escapeHtml(invoiceNumber)}
          </p>
          <p style="margin:0;font-size:14px;color:#2F3A2E;">
          ...
          ${dueLabel ? `
          <p style="margin:0;font-size:14px;color:#2F3A2E;">
            <strong>Date d'échéance :</strong>&nbsp;${dueLabel}
          </p>` : ""}
        </td>
      </tr>
    </table>
    ...
    <table cellpadding="0" cellspacing="0" width="100%"
      ...
      <thead>
        <tr style="background:#2F3A2E;">
          ...
          <th style="padding:10px 14px;font-size:11px;font-weight:700;letter-spacing:.07em;text-transform:uppercase;color:#e9e3d7;text-align:right;">Prix unit.</th>
          <th style="padding:10px 14px;font-size:11px;font-weight:700;letter-spacing:.07em;text-transform:uppercase;color:#e9e3d7;text-align:right;">Total HT</th>
        </tr>
      </thead>
