...
const PAYMENT_INCLUDE = {
  ...
  // registered in the Stripe Dashboard, still open — see PRE_LAUNCH_FIXES.md
...
async function sendAppointmentRefundEmail({ customerEmail, customerName, appointmentDate }) {
  ...
  const dateStr = appointmentDate ? new Date(appointmentDate).toLocaleDateString("fr-FR") : "prévu";
  await sendEmail({
    to: customerEmail,
