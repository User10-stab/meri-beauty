...
export default async function CashSessionPage() {
  ...
  // Opening, closing and the run of past sessions. The drawer movements and
  // bank deposits of any one opening belong to that opening's book, at
  // /dashboard/boutique/caisse/[sessionId], and are fetched there.
