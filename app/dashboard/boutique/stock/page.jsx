...
export async function generateMetadata() {
  ...
  return {
    title: `${t("dashboardBoutique.stock.title")} — ${t("dashboardBoutique.title")} — Dashboard`,
    description: t("dashboardBoutique.stock.subtitle"),
  };
}
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        {lowStockCount > 0 && (
          <div className="flex items-center gap-2 rounded-xl bg-amber-50 px-3.5 py-2 text-amber-700">
            ...
            <span className="text-xs font-medium">{t("lowStockLabel")}</span>
          </div>
        )}
      </div>
