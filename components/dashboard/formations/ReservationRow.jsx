...
export function ReservationRow({ row, onEdit, onDelete, onSettle, onNoShow, onSendCheckIn, onResendPayment, isResendingPayment = false, highlighted = false, rowRef }) {
  ...
  return (
    <tr
      ref={rowRef}
      className={`group border-b border-gray-100 transition-colors hover:bg-gray-50/70 ${highlighted ? "bg-indigo-50/60 ring-2 ring-inset ring-indigo-500 dark:bg-indigo-900/20" : ""}`}
    >
      {/* Formation */}
      ...
      <td className="px-4 py-4 pr-5 align-middle whitespace-nowrap">
        <div className="flex items-center justify-end gap-2">
          ...
          {/* The online payment never went through (hold still pending or
              ...
              client a fresh Stripe link — the formation counterpart of the
