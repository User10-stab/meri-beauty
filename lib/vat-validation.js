  ...
  for (let attempt = 0; attempt < VIES_MAX_ATTEMPTS; attempt += 1) {
    ...
    try {
      ...
      return {
        ...
        message: "Le service européen de vérification (VIES) est actuellement injoignable. Le numéro peut être enregistré en attente de vérification.",
      };
    }
    ...
    if (parsed.fault) {
      ...
      return {
        success: false,
        reason: "VIES_UNAVAILABLE",
        message: "Le service VIES reste temporairement indisponible pour ce pays. Le numéro peut être enregistré en attente de vérification.",
      };
    }
    ...
    if (!response.ok) {
      ...
      return {
        success: false,
        reason: "VIES_UNAVAILABLE",
        message: "Impossible de contacter le service VIES. Le numéro peut être enregistré en attente de vérification.",
      };
    }
