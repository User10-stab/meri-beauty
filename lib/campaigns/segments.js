...
export const SEGMENTS = Object.freeze([
  ...
  { value: "prospects_lecteur", label: "Prospects lecteurs (ont ouvert)" },
  { value: "prospects_engage", label: "Prospects engagés (ont cliqué)" },
  { value: "prospects_interesse", label: "Prospects intéressés" },
  { value: "prospects_essai", label: "Prospects en essai (RDV/atelier)" },
...
export async function getSegmentRecipients(segment) {
  switch (segment) {
    ...
    case "prospects_actifs":
      return prospectRecipients({ status: { in: ["contacte", "lecteur", "engage", "interesse", "demo_essai"] } });

    case "prospects_lecteur":
      return prospectRecipients({ status: "lecteur" });

    case "prospects_engage":
      return prospectRecipients({ status: "engage" });

    case "prospects_interesse":
      return prospectRecipients({ status: "interesse" });

    case "prospects_essai":
      return prospectRecipients({ status: "demo_essai" });
