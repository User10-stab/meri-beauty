 ...
 * - Otherwise: calculate by weight tiers, exact carrier cost net of VAT, no markup
 *
...
// discount — "prix public"), exactly the HT prices from the source grid.
//
// These used to be wrapped in a priceInclVat() helper that added 21 % here,
// only for applyVatRate() to strip it again downstream. Now that the whole
// catalogue is stored net, the grid figures are used as they are printed and
// the tax is applied once, at the point the customer's rate is known — which
// also means an intra-Community B2B order no longer pays Belgian VAT on
// carriage it is exempt from.
const MONDIAL_RELAY_TIERS = [
  { maxGrams: 500, price: 3.12 },    // jusqu'à 500g
  { maxGrams: 1000, price: 3.22 },   // jusqu'à 1kg
  { maxGrams: 2000, price: 3.42 },   // jusqu'à 2kg
  { maxGrams: 4000, price: 3.82 },   // jusqu'à 4kg
  { maxGrams: 10000, price: 5.43 },  // jusqu'à 10kg
  { maxGrams: 25000, price: 14.77 }, // jusqu'à 25kg
  { maxGrams: 30000, price: 19.99 }, // jusqu'à 30kg (max Mondial Relay parcel)
];
 ...
 * @returns {number|string} Shipping cost in EUR, NET of VAT (applyVatRate adds it), or "QUOTE_REQUIRED" for >30kg
 */
