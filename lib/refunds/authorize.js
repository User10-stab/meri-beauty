...
export function authorizeRefund({
  ...
  if (source === "APPOINTMENT") {
    ...
    if (appointment.status === "COMPLETED") return deny(REFUND_DENIAL.COMPLETED_NOT_REFUNDABLE);
  ...
  if (source === "WORKSHOP" || source === "FORMATION") {
    ...
    if (reservation.status === "COMPLETED") return deny(REFUND_DENIAL.COMPLETED_NOT_REFUNDABLE);
