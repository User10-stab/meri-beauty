...
export const STAFF_PERMISSION_OPTIONS = Object.freeze([
  ...
  { key: STAFF_PERMISSIONS.SEND_TICKET_EMAIL, label: "Envoi du ticket par e-mail", description: "Envoyer par e-mail le ticket de caisse déjà généré à son propre client." },
]);
