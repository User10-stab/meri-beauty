...
export const metadata = {
  ...
  description: "Visualisez toutes les réservations confirmées du salon.",
};
...
export default async function CalendarPage() {
  ...
  const [appointmentsResult, staffResult, salonResult] = await Promise.all([
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="mt-1 text-sm font-medium text-gray-500 dark:text-dark-6">
          Consultez toutes les réservations confirmées.
        </p>
      </div>
