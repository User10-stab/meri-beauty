...
function invalidResult(message = "Num̩ro de TVA invalide.") {
...
async function verifyVatWithViesRest(split) {
  ...
  try {
    ...
    return unavailableResult("Le service europ̩en de v̩rification (VIES) est actuellement injoignable. Le num̩ro peut ̻tre enregistr̩ en attente de v̩rification.");
  }
  ...
  return unavailableResult("Le service VIES reste temporairement indisponible pour ce pays. Le num̩ro peut ̻tre enregistr̩ en attente de v̩rification.");
}
