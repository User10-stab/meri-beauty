 ...
 *
 * So this is deliberately NOT the grantable
 * STAFF_PERMISSIONS.SEND_TICKET_EMAIL check it used to be. That permission
 * still exists and is still shown in the staff form, but holding it no
 * longer opens this door: accounts created before this change still carry
 * the key in `Staff.dashboardPermissions` (it was in
 * DEFAULT_STAFF_PERMISSIONS until now), and a permission check alone would
 * quietly hand every one of them the salon's letterhead back.
 *
